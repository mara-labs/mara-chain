...
func AddTxFlags(cmd *cobra.Command) (*cobra.Command, error) {
	...
	cmd.PersistentFlags().String(flags.FlagFees, "", "Fees to pay along with transaction; eg: 10amara")
	cmd.PersistentFlags().String(flags.FlagGasPrices, "", "Gas prices to determine the transaction fee (e.g. 10amara)")

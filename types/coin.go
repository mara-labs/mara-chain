...
const (
	// AttoPhoton defines the default coin denomination used in Mara in:
	//
...
// NewPhotonCoinInt64 is a utility function that returns an "amara" coin with the given int64 amount.
// The function will panic if the provided amount is negative.
